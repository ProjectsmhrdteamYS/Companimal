...
<head>
 ...
 <title>메인</title>
   ...
   <style>
    /* 공통 style */
    .nav{list-style-type:none; font-weight: 600; text-decoration: none;  color :#150906; }
...
<div class="col-md-1 me-4 text-center ">
  <a onclick="location.href='${cpath }/companimal.do'">
	  <img class="rounded-circle" src="${cpath }/images/icon_1.png" alt="icon_1" width="100" height="100">
  </a>    
</div>
...
<div class="col-md-1 me-4 text-center">
  <a onclick="location.href='${cpath }/searchform.do'">
  	<img class="rounded-circle" src="${cpath }/images/icon_2.png" alt="icon_1" width="100" height="100">
  </a>
</div>
<!-- col_3 -->

<div class="col-md-1 me-4 text-center">
  <a onclick="location.href='${cpath }/checkform.do'">
  	<img class="rounded-circle" src="${cpath }/images/icon_3.png" alt="icon_1" width="100" height="100">
  </a>  
</div>
<!-- col_4 -->

<div class="col-md-1 me-4 text-center">
  <a onclick="location.href='${cpath }/boardform.do'">
  	<img class="rounded-circle" src="${cpath }/images/icon_4.png" alt="icon_1" width="100" height="100">
  </a>   
</div>
<!-- con_5 -->
<div class="col-md-1 me-4 text-center">
  <a onclick="location.href='${cpath }/findboardform.do'">
  	<img class="rounded-circle" src="${cpath }/images/icon_5.png" alt="icon_1" width="100" height="100">
  </a>
</div>

<div class="row pt-5">
  <div class="col-md-6">
    <div class="h-100 p-5 text-white bg-dark rounded-3"  style="background-image:url(images/main_con_1.jpg); background-size: cover;">
  ...
  <div class="col-md-6">
    <div class="h-100 p-5 bg-light border rounded-3"style="background-image:url(images/main_con_2.jpg); background-size: cover;" >
