...
<body>
		...
		<div class="container p-3">
			<div
				...
				<ul
					...
					<li><a href="#" onclick="moveUrl('${cpath }/searchform.do')"
						class="nav-link px-3 link-dark">반려견조회</a></li>
					<li><a href="#" onclick="moveUrl('${cpath }/checkform.do')"
	...
	<div class="form-signin">
		<form class="search rounded-4 p-5 mx-auto h-100" style="width: 650px;"
			action="${cpath }/signin.do">
			<a class="logo" href="${cpath }/mainpage.do"> <img class="mx-5"
				src="${cpath }/images/logo.png" alt="로고" width="80%">
			</a> <br> <br>
			<div class="badge bg-primary text-wrap mx-5" style="width: 6rem;">
				로그인</div>
			<br>
			<div class="form-floating mb-2">
				<input type="text" class="form-control" id="floatingInput"
					name="user_id" placeholder="id"> <label for="floatingInput">ID</label>
			</div>
			...
			<button class="w-100 btn btn-lg btn-primary mb-4" type="submit">Sign
				in</button>
		</form>
	</div>
